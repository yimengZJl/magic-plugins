...
public interface WorkflowStore {
     ...
     */
    public Step createCurrentStep(String entryId, int stepId, String owner, Date startDate, Date dueDate, String status, String[] previousIds) throws StoreException, SQLException;
     ...
     */
    public WorkflowEntry createEntry(String workflowName) throws StoreException, SQLException;
